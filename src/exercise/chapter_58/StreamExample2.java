...
public class StreamExample2 {
    public static void main(String[] args) {
        ...
        customers.add(new Customer("C002", "송영길"));
        customers.add(new Customer("C002", "송영길"));
        customers.add(new Customer("C001", "이재명"));
        customers.add(new Customer("C003", "안철수"));
        customers.add(new Customer("C001", "이재명"));
        customers.add(new Customer("C003", "안철수"));
        customers.add(new Customer("C004", "조국"));

        Customer myCustomer = new Customer("C001", "이재명");
        ...
        List<Integer> bonusPoints = customers
                .stream()
