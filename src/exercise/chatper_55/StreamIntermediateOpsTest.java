...
public class StreamIntermediateOpsTest {
    ...
    public static void main(String[] args){
        ...
        List<String> fruitList3 = fruits.stream().limit(4).collect(Collectors.toList());
        ...
        System.out.println("Limit 적용 후 : " + fruitList5);

        List<String> fruitList6 = fruits.stream().sorted( (fruit1, fruit2) -> fruit1.length() - fruit2.length()).collect(Collectors.toList());
        System.out.println("String 길이 짧은 순서 : " + fruitList6);


        // sorted: String 길이 짧은순 으로 정렬

        List<String> fruitList7 = fruits.stream().sorted( (fruit1, fruit2) -> fruit2.length() - fruit1.length()).collect(Collectors.toList());
        System.out.println("String 길이 짧은 순서 : " + fruitList7);
